<!-- theme: lava | mode: daily | date: 2026-09-02 -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/art/lava/hero-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="./assets/art/lava/hero-light.svg">
  <img src="./assets/art/lava/hero-light.svg" width="100%" alt="Muhammad Hassaan Javed, GitHub handle @itxcrusher. Lava theme." />
</picture>

<picture><source media="(prefers-color-scheme: dark) and (max-width: 479px)" srcset="./assets/pages/lava/top-xs-dark.svg"><source media="(max-width: 479px)" srcset="./assets/pages/lava/top-xs-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 767px)" srcset="./assets/pages/lava/top-sm-dark.svg"><source media="(max-width: 767px)" srcset="./assets/pages/lava/top-sm-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 1199px)" srcset="./assets/pages/lava/top-md-dark.svg"><source media="(max-width: 1199px)" srcset="./assets/pages/lava/top-md-light.svg"><source media="(prefers-color-scheme: dark)" srcset="./assets/pages/lava/top-lg-dark.svg"><img src="./assets/pages/lava/top-lg-light.svg" width="100%" alt="Opening statement: this account builds infrastructure and bounded automation for other people's production systems, most of it in private repositories, followed by a runnable check that the work is real. The same words are in the plain-text copy at the foot of the page." /></picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/art/lava/signoff-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="./assets/art/lava/signoff-light.svg">
  <img src="./assets/art/lava/signoff-light.svg" width="100%" alt="Closing line at the end of the page: stay cool" />
</picture>

<picture><source media="(prefers-color-scheme: dark) and (max-width: 479px)" srcset="./assets/pages/lava/close-xs-dark.svg"><source media="(max-width: 479px)" srcset="./assets/pages/lava/close-xs-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 767px)" srcset="./assets/pages/lava/close-sm-dark.svg"><source media="(max-width: 767px)" srcset="./assets/pages/lava/close-sm-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 1199px)" srcset="./assets/pages/lava/close-md-dark.svg"><source media="(max-width: 1199px)" srcset="./assets/pages/lava/close-md-light.svg"><source media="(prefers-color-scheme: dark)" srcset="./assets/pages/lava/close-lg-dark.svg"><img src="./assets/pages/lava/close-lg-light.svg" width="100%" alt="Contact lines: how to reach Muhammad Hassaan Javed, by the agency site, the personal site, or directly by email. The same words are in the plain-text copy at the foot of the page." /></picture>
...
22 original public repositories. Most of the work is not here: over the last 12 months, 5,881 of 7,062 contributions were in private repositories (client delivery, product builds, and security research).
...
_Generated 2026-09-02 from the GitHub API._

</details>

<!-- PUBLIC_SURFACE:END -->

<sub>Today this page wears <b>Lava</b>, one of 47 looks it rotates through daily. <a href="assets/pages/README.md">See them all</a>.</sub>
