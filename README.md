<!-- theme: frost | mode: daily | date: 2026-09-13 -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/art/frost/hero-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="./assets/art/frost/hero-light.svg">
  <img src="./assets/art/frost/hero-light.svg" width="100%" alt="Muhammad Hassaan Javed, GitHub handle @itxcrusher. Frost theme." />
</picture>

<picture><source media="(prefers-color-scheme: dark) and (max-width: 479px)" srcset="./assets/pages/frost/top-xs-dark.svg"><source media="(max-width: 479px)" srcset="./assets/pages/frost/top-xs-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 767px)" srcset="./assets/pages/frost/top-sm-dark.svg"><source media="(max-width: 767px)" srcset="./assets/pages/frost/top-sm-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 1199px)" srcset="./assets/pages/frost/top-md-dark.svg"><source media="(max-width: 1199px)" srcset="./assets/pages/frost/top-md-light.svg"><source media="(prefers-color-scheme: dark)" srcset="./assets/pages/frost/top-lg-dark.svg"><img src="./assets/pages/frost/top-lg-light.svg" width="100%" alt="Opening statement: this account builds infrastructure and bounded automation for other people's production systems, most of it in private repositories, followed by a runnable check that the work is real. The same words are in the plain-text copy at the foot of the page." /></picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/art/frost/signoff-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="./assets/art/frost/signoff-light.svg">
  <img src="./assets/art/frost/signoff-light.svg" width="100%" alt="Closing line at the end of the page: stay warm" />
</picture>

<picture><source media="(prefers-color-scheme: dark) and (max-width: 479px)" srcset="./assets/pages/frost/close-xs-dark.svg"><source media="(max-width: 479px)" srcset="./assets/pages/frost/close-xs-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 767px)" srcset="./assets/pages/frost/close-sm-dark.svg"><source media="(max-width: 767px)" srcset="./assets/pages/frost/close-sm-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 1199px)" srcset="./assets/pages/frost/close-md-dark.svg"><source media="(max-width: 1199px)" srcset="./assets/pages/frost/close-md-light.svg"><source media="(prefers-color-scheme: dark)" srcset="./assets/pages/frost/close-lg-dark.svg"><img src="./assets/pages/frost/close-lg-light.svg" width="100%" alt="Contact lines: how to reach Muhammad Hassaan Javed, by the agency site, the personal site, or directly by email. The same words are in the plain-text copy at the foot of the page." /></picture>
...
24 original public repositories. Most of the work is not here: over the last 12 months, 6,616 of 8,324 contributions were in private repositories (client delivery, product builds, and security research).
...
_Generated 2026-09-13 from the GitHub API._

</details>

<!-- PUBLIC_SURFACE:END -->

<sub>Today this page wears <b>Frost</b>, one of 47 looks it rotates through daily. <a href="assets/pages/README.md">See them all</a>.</sub>
