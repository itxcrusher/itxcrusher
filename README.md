<!-- theme: granite | mode: daily | date: 2026-08-29 -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/art/granite/hero-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="./assets/art/granite/hero-light.svg">
  <img src="./assets/art/granite/hero-light.svg" width="100%" alt="Muhammad Hassaan Javed, GitHub handle @itxcrusher. Granite theme." />
</picture>

<picture><source media="(prefers-color-scheme: dark) and (max-width: 479px)" srcset="./assets/pages/granite/top-xs-dark.svg"><source media="(max-width: 479px)" srcset="./assets/pages/granite/top-xs-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 767px)" srcset="./assets/pages/granite/top-sm-dark.svg"><source media="(max-width: 767px)" srcset="./assets/pages/granite/top-sm-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 1199px)" srcset="./assets/pages/granite/top-md-dark.svg"><source media="(max-width: 1199px)" srcset="./assets/pages/granite/top-md-light.svg"><source media="(prefers-color-scheme: dark)" srcset="./assets/pages/granite/top-lg-dark.svg"><img src="./assets/pages/granite/top-lg-light.svg" width="100%" alt="Opening statement: this account builds infrastructure and bounded automation for other people's production systems, most of it in private repositories, followed by a runnable check that the work is real. The same words are in the plain-text copy at the foot of the page." /></picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/art/granite/signoff-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="./assets/art/granite/signoff-light.svg">
  <img src="./assets/art/granite/signoff-light.svg" width="100%" alt="Closing line at the end of the page: set in stone" />
</picture>

<picture><source media="(prefers-color-scheme: dark) and (max-width: 479px)" srcset="./assets/pages/granite/close-xs-dark.svg"><source media="(max-width: 479px)" srcset="./assets/pages/granite/close-xs-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 767px)" srcset="./assets/pages/granite/close-sm-dark.svg"><source media="(max-width: 767px)" srcset="./assets/pages/granite/close-sm-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 1199px)" srcset="./assets/pages/granite/close-md-dark.svg"><source media="(max-width: 1199px)" srcset="./assets/pages/granite/close-md-light.svg"><source media="(prefers-color-scheme: dark)" srcset="./assets/pages/granite/close-lg-dark.svg"><img src="./assets/pages/granite/close-lg-light.svg" width="100%" alt="Contact lines: how to reach Muhammad Hassaan Javed, by the agency site, the personal site, or directly by email. The same words are in the plain-text copy at the foot of the page." /></picture>
...
22 original public repositories. Most of the work is not here: over the last 12 months, 5,568 of 6,679 contributions were in private repositories (client delivery, product builds, and security research).
...
_Generated 2026-08-29 from the GitHub API._

</details>

<!-- PUBLIC_SURFACE:END -->

<sub>Today this page wears <b>Granite</b>, one of 47 looks it rotates through daily. <a href="assets/pages/README.md">See them all</a>.</sub>
