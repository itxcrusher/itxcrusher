<!-- theme: crt | mode: daily | date: 2026-09-22 -->
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/art/crt/hero-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="./assets/art/crt/hero-light.svg">
  <img src="./assets/art/crt/hero-light.svg" width="100%" alt="Muhammad Hassaan Javed, GitHub handle @itxcrusher. CRT theme." />
</picture>

<picture><source media="(prefers-color-scheme: dark) and (max-width: 479px)" srcset="./assets/pages/crt/top-xs-dark.svg"><source media="(max-width: 479px)" srcset="./assets/pages/crt/top-xs-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 767px)" srcset="./assets/pages/crt/top-sm-dark.svg"><source media="(max-width: 767px)" srcset="./assets/pages/crt/top-sm-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 1199px)" srcset="./assets/pages/crt/top-md-dark.svg"><source media="(max-width: 1199px)" srcset="./assets/pages/crt/top-md-light.svg"><source media="(prefers-color-scheme: dark)" srcset="./assets/pages/crt/top-lg-dark.svg"><img src="./assets/pages/crt/top-lg-light.svg" width="100%" alt="Opening statement: this account builds infrastructure and bounded automation for other people's production systems, most of it in private repositories, followed by a runnable check that the work is real. The same words are in the plain-text copy at the foot of the page." /></picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/art/crt/signoff-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="./assets/art/crt/signoff-light.svg">
  <img src="./assets/art/crt/signoff-light.svg" width="100%" alt="Closing line at the end of the page: NO SIGNAL" />
</picture>

<picture><source media="(prefers-color-scheme: dark) and (max-width: 479px)" srcset="./assets/pages/crt/close-xs-dark.svg"><source media="(max-width: 479px)" srcset="./assets/pages/crt/close-xs-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 767px)" srcset="./assets/pages/crt/close-sm-dark.svg"><source media="(max-width: 767px)" srcset="./assets/pages/crt/close-sm-light.svg"><source media="(prefers-color-scheme: dark) and (max-width: 1199px)" srcset="./assets/pages/crt/close-md-dark.svg"><source media="(max-width: 1199px)" srcset="./assets/pages/crt/close-md-light.svg"><source media="(prefers-color-scheme: dark)" srcset="./assets/pages/crt/close-lg-dark.svg"><img src="./assets/pages/crt/close-lg-light.svg" width="100%" alt="Contact lines: how to reach Muhammad Hassaan Javed, by the agency site, the personal site, or directly by email. The same words are in the plain-text copy at the foot of the page." /></picture>
...
24 original public repositories. Most of the work is not here: over the last 12 months, 6,808 of 8,565 contributions were in private repositories (client delivery, product builds, and security research).
...
_Generated 2026-09-22 from the GitHub API._

</details>

<!-- PUBLIC_SURFACE:END -->

<sub>Today this page wears <b>CRT</b>, one of 47 looks it rotates through daily. <a href="assets/pages/README.md">See them all</a>.</sub>
